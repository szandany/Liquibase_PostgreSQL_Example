...
--changeset AmyS:45678-createtablecolors context:DEV,TEST
CREATE TABLE colors (
  id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  bcolor VARCHAR,
  fcolor VARCHAR
...
--changeset TsviZ:45680-create_function_film_count endDelimiter:#
create or replace function film_count (len_from int, len_to int)
returns int
as
'
declare
...
language plpgsql
#
--rollback drop function film_count
